<template>
    <section>
        ...
        <el-dialog
            title="Larger dialog to contain more data"
            :visible.sync="dialogVisible"
            width="80%">
            <p>A maximum width of 80% can be used if needed.</p>
            <el-row :gutter="20">
                <el-col :span="12">
                    <el-tabs value="first">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button size="small" type="success" @click="dialogVisible = false">Save</el-button>
            </span>
        </el-dialog>
    </section>
</template>
