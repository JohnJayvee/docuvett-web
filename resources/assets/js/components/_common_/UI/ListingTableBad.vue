<template>
    <section>
        ...
        <el-table
            ...
            <el-table-column key="table-actions" label="Actions" align="right" min-width="300px" prop="actions">
                <template>
                    <el-tooltip
                        effect="dark"
                        content="Delete"
...
<script>
    ...
    export default {
        ...
        methods: {
            handleConfirmation() {
                this.$confirm(`You are about to do something dangerous. Continue?`, 'Warning', {
                    type: 'warning'
                }).then(() => {
